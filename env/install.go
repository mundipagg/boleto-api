...
func ConfigMock(port string) {
	...
	os.Setenv("URL_STONEBANK_TOKEN", "http://localhost:"+port+"/auth/realms/stone_bank/protocol/openid-connect/token")
...
func configFlags(devMode, mockMode, disableLog bool) {
	if devMode {
		...
		os.Setenv("URL_STONEBANK_TOKEN", "https://sandbox-accounts.openbank.stone.com.br/auth/realms/stone_bank/protocol/openid-connect/token")
		os.Setenv("STONEBANK_TOKEN_DURATION_IN_MINUTES", "15")
		os.Setenv("STONEBANK_AUDIENCE", "https://sandbox-accounts.openbank.stone.com.br/auth/realms/stone_bank")
		os.Setenv("STONEBANK_CLIENT_ID	", "3279b005-5e40-41c1-996e-8cec24f8006b")
