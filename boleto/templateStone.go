...
<div class="document">
        ...
        <table cellspacing="0" cellpadding="0" border="1">
            ...
            <tr>
                <td width="80%" colspan="6">
                    <span class="title">Nome do Beneficiário / CNPJ / CPF :</span>
                    <br/>
            ...
            <tr>
                <td colspan="6" rowspan="4">
                    <span class="title">Stone Pagamentos S.A. O boleto deve ser pago, preferencialmente, no aplicativo da Stone. Até o vencimento pode ser pago em qualquer banco ou correspondente não bancário.</span>
