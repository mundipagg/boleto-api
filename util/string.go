...
//IsSpecialCaracterCaixa Verifica se um caracter especial é aceito Caixa Econômica, de acordo com o  código decimal da Tabela ASCII
...
//			.	46
//			/	47
func IsSpecialCharacterCaixa(r rune) bool {
	return (r >= 32 && r <= 34) || (r >= 38 && r <= 47) || (r >= 58 && r <= 63) || r == 95
}
